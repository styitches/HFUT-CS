...
HD_PWD='D:/Progress/Vivado/multiple_instruction_cpu/multiple_instruction_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_10.tcl
