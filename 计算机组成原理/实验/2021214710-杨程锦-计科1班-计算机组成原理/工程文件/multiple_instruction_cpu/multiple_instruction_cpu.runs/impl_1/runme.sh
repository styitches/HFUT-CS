...
HD_PWD='D:/Progress/Vivado/multiple_instruction_cpu/multiple_instruction_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_10.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_10.tcl -notrace
